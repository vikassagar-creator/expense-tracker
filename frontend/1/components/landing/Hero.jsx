...
// Landing page hero section: headline, CTA buttons, and a static
// mock dashboard preview (hardcoded sample numbers, not live data).
    ...
    <section className="hero">
      <div className="hero-container">
        ...
        <div className="hero-content">
          <span className="hero-eyebrow">SMART • SIMPLE • SECURE</span>

          <h1>
            Take Control of Your <span>Finances With Clarity.</span>
          </h1>

          <p className="hero-description">
            Track every expense, visualize your spending, and build better
            financial habits.
          </p>
