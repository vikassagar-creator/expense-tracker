...
// Landing page "Features" grid. Edit the `features` array below to
// add/remove/reorder feature cards — the layout renders automatically.
...
const features = [
  ...
  },
  {
    ...
    description: "Record, organize, and manage your daily expenses with ease.",
  },
  {
    icon: FaLock,
  ...
  },
  {
    ...
    description: "Review your previous expenses and transactions in one place.",
  },
  {
    icon: FaMobileAlt,
  ...
  return (
    <section id="features" className="features">
      <div className="features-header">
        ...
        <p>
          Track, analyze, and manage your expenses with simple tools designed to
