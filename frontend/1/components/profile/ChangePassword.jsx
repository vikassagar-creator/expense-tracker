...
// Password change form on the Profile page. Requires current password
// + new password twice, then calls the change-password API endpoint.
// Now shares utils/passwordRules.js with Register.jsx, so both forms
// enforce the same complexity requirements.
